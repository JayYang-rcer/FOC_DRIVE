...
#define WRAP_PM_PI(theta) theta = (theta > M_PI)  ? theta - M_2PI : theta; theta = (theta < -M_PI) ? theta + M_2PI : theta; // Wrap theta to [-pi, pi)
#define WRAP_0_2PI(theta) theta = (theta > M_2PI) ? theta - M_2PI : theta; theta = (theta < 0.0f ) ? theta + M_2PI : theta; // Wrap theta to [0, 2pi)
